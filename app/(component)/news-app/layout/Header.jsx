...
export default function Header({ quary, handelSearch , handelSelectCategory, categorie}) {
    return (
        <header className='bg-primary py-3 px-4 shadow text-white row gy-2 d-flex align-items-center justify-content-between rounded-bottom mb-3 flex-column flex-md-row '>
            <h3 className="fw-bolder h2 col-2 ">News App</h3>
            <CategoriesSelect handelSelectCategory={handelSelectCategory} categorie={categorie}/>
            <div className="search col-12 col-md-4">
